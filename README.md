...
## Streamlining EKS Deployment and CI/CD: A Step-by-Step Process to Automating Application Delivery with Jenkins and Terraform
...
In this article, I have created a fully functional EKS cluster and a simple containerized application up and running, with a CI/CD pipeline that automates the entire process from code to production.
...
for this Project, we will Run Nginx as sample application.
...
terraform {
  backend "s3" {
    bucket = "terraform-eks-cicd-171717"
